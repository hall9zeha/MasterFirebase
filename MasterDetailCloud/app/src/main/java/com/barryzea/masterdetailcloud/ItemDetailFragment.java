...
import com.barryzea.masterdetailcloud.databinding.FragmentItemDetailBinding;
...
public class ItemDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = Foods.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
        }
    }
